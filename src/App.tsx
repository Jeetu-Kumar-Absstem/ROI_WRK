      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
        ...
        <div className="flex items-center gap-4 mb-6 print:hidden">
          ...
          <button
            ...
            className="px-6 py-2.5 rounded-full text-sm transition-all duration-150 hover:bg-cyan-50"
            style={{
              fontFamily: "'Lufga', sans-serif",
              fontWeight: 600,
              background: activeGroup === 'existing-psa' ? '#0891b2' : '#fff',
              color: activeGroup === 'existing-psa' ? '#fff' : '#0891b2',
